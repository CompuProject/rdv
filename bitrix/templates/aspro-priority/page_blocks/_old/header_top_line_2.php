	...
	<div class="maxwidth-theme">
		...
		<div class="top-block-item col-md-3 pull-right">
			<div class="phone-block">
				...
				<div class="inline-block">
					<span class="callback-block animate-load twosmallfont colored" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]["aspro_priority_form"]["aspro_priority_callback"][0]?>" data-name="callback"><?=GetMessage("S_CALLBACK")?></span>
				</div>
			</div>
		</div>
	</div>
