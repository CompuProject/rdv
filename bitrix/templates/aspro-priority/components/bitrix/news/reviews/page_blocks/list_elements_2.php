...
<div class="add_review">
	<div class="button">
		<span class="btn btn-default btn-lg animate-load" data-event="jqm" data-param-id="<?=CPriority::getFormID("aspro_priority_add_review")?>" data-name="add_review"><?=GetMessage('ADD_REVIEW')?></span>
	</div>
</div>
