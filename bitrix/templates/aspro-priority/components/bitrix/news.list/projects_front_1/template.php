		...
		<div class="maxwidth-theme">
			...
			<div class="items row flexbox">
				...
				<?foreach($arResult['ITEMS'] as $i => $arItem):?>
					...
					?>
					<div class="item clearfix<?=($bBigBlock ? ' big_block' : '')?><?=(!$bImage ? ' wti' : '')?><?=($textColor ? ' '.$textColor : '')?> col-md-<?=($bBigBlock ? 6 : 3)?> col-sm-4 col-xs-6">
			...
			if((int)$arResult['NAV_RESULT']->nEndPage > 1):?>
				<div class="ajax_btn">
                    ...
                    <a class="btn btn-default btn-sm" href="/projects/">Все проекты</a>
				</div>
			<?endif?>
            <div class="ajax_btn">
            </div>
