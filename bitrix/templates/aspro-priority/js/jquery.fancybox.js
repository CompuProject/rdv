...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		_setDimension: function () {
			...
			//var fancyboxInnerHeight = $('.fancybox-inner img').height();
			//if(typeof(fancyboxInnerHeight) === 'undefined'){
				$('.fancybox-inner img').css('opacity', 0);
				setTimeout(function(){
					var fancyboxInnerHeight = ($('.fancybox-inner video').length ? $('.fancybox-inner video').height() : $('.fancybox-inner img').height());
					$('.fancybox-inner').height(fancyboxInnerHeight);
					setTimeout(function(){
						$('.fancybox-inner img').animate({'opacity': 1}, 150);
					}, 150);
				}, 300);
			//}
			/*else{
				$('.fancybox-inner').height(fancyboxInnerHeight);
					console.log(fancyboxInnerHeight, 2)
			}*/
