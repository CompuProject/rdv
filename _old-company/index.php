...
<img src="/images/services/proekti/about.jpg" class="img-responsive">
...
<div class="tizers in_content text-right">
	<div class="wrap text-center clearfix">
		<div class="tizer image_bg text-left">
			<div class="image">
 <img alt="Конфиденциальность" src="/bitrix/templates/aspro-priority/images/svg/privacy.svg" title="Конфиденциальность">
			</div>
			<div class="body-info">
				<div class="title">
					Конфиденциальность
		...
		<div class="tizer image_bg text-left">
			<div class="image">
 <img alt="500 компаний" src="/bitrix/templates/aspro-priority/images/svg/companies.svg" title="500 компаний">
			</div>
			<div class="body-info">
				<div class="title">
					 500 компаний
		...
		<div class="tizer image_bg text-left">
			<div class="image">
 <img alt="Гарантия результата" src="/bitrix/templates/aspro-priority/images/svg/guarantee.svg" title="Гарантия результата">
			</div>
			<div class="body-info">
				<div class="title">
					Гарантия результата
